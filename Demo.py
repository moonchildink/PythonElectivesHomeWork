...
myImg = Plt.imread(r'timg11.jpg')

myWordCloud = WCloud(font_path=r"FZXKTJW.TTF", background_color='white', max_font_size=100, max_words=2000, mask = myImg)
myWordCloud.generate(JbDict)

myImg_color = ImgCG(myImg)
myWordCloud.recolor(color_func = myImg_color)

myWordCloud.to_file(r"Wcdemo.png")
